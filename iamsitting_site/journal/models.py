...
""" journal models.py
The journal module handles all journal related data
DATA MODELS:
      - Article: journal article with author, title, content, etc.
      - Comment: article may have comments
      - Category: journal Category (music, education, sports, etc.)
"""
...
class Article(models.Model):
  ...
  status = models.CharField(max_length=1, choices=ARTICLE_STATUS, default='P')
